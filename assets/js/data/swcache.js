...
const resource = [
  ...
  '{{ favicon_path }}/suhomi-192x192.png',
  '{{ favicon_path }}/suhomi-512x512.png',
  '{{ favicon_path }}/suhomi-192x192.png',
  '{{ favicon_path }}/onew-16x16.png',
  '{{ favicon_path }}/onew-32x32.png',
  '{{ favicon_path }}/onew.ico',
  '{{ favicon_path }}/onew-150x150.png',
